        ...
        foreach((array) $modified as $v) {
            if(isset($entity->{$v}) and $entity->{$v} != null) {
                ...
                if(is_array($entity->{$v})){
                    ...
                    $entity->{$v} = strip_tags( (string) $entity->{$v},'<button><fieldset><h1><h2><h3><h4><h5><h6><small><label><img><button><fieldset><h1><h2><h3><h4><h5><h6><small><label><img><img><p><a><b><br><strong><br /><hr><i><span><div><ul><li><table><tr><td><thead><tbody>');
                }
            }
        }
        return true;
