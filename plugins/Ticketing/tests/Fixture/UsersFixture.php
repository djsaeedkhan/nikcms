...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'family' => ['type' => 'string', 'length' => 50, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'token' => ['type' => 'string', 'length' => 50, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2023-02-20 01:54:05',
                'modified' => '2023-02-20 01:54:05',
                'expired' => '2023-02-20 01:54:05',
            ],
        ];
        parent::init();
    }
