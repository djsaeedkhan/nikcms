...
<fieldset class="mb-2">
    <legend><?= __('ویرایش زمانبندی') ?></legend>
    <?php
        ...
        echo $this->Form->control('dates1',[
            'id'=>'pdpGregorian',
            'type'=>'text',
            'dir'=>'ltr',
            'label'=>'انتخاب تاریخ',
            'class'=>'form-control',
            'value'=>$challengetimeline->dates != ""?
                jdate('Y-m-d H:i:s', strtotime($challengetimeline->dates->format('Y-m-d H:i:s')))
                :false
        ]);
        echo $this->Form->control('dates',[
            'id'=>'gdate',
            'value'=>$challengetimeline->dates->format('Y-m-d H:i:s'),
            'type'=>'hidden',
        ]);
    ?>
</fieldset>
