...
function config() {
    ...
    $config.endtime_message = 'مدت زمان پاسخگویی به پایان رسید';
...
function countdown($element, $daysAdd, $hoursAdd, $minutesAdd, $secondsAdd) {
    ...
    var interval = setInterval(function() {
        ...
        // TIMER
        $timerHtmlStart = '<span style="color: ' + $config.timer_color + '; font-weight: ' + $config.timer_font_weight + '; font-size: ' + $config.timer_font_size + 'px;">';
        $timerHtmlEnd = '</span>';
