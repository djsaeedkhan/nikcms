                ...
                <div class="card p-4">
                    <div class="card-body">
                        ...
                        echo $this->Form->control('mobile',[
                            ...
                            'default' => $user['data']['SmsValidations']['mobile'],
                            'dir'=>'ltr','required']);
                        ?>
                        <!-- <div class="alert alert-warning" style="padding:5px;">
                            کدتایید به شماره  
                            <b><?=$user['data']['SmsValidations']['mobile'];?></b>
                            ارسال خواهد شد 
                            در صورتی که شماره تلفن همراه اشتباه است آن را اصلاح نمایید
                        </div> -->
                        <div class="clearfix"></div><br>
                        <button type="submit" class="btn btn-primary px-4 float-left">ارسال پیامک تایید</button>
