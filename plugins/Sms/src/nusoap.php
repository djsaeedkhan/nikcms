...
class wsdl extends nusoap_base
{
    ...
    function webDescription()
    {
		...
		<script nonce="<?=get_nonce?>" language="JavaScript" type="text/javascript">
		<!--
		// POP-UP CAPTIONS...
        ...
        foreach ($this->getOperations() as $op => $data) {
            $b .= "<li><a href='#' nonce='".get_nonce."'  onclick=\"popout();popup('$op')\">$op</a></li>";
            // create hidden div
            $b .= "<div id='$op' class='hidden'>
				    <a href='#' nonce='".get_nonce."'  onclick='popout()'><font color='#ffffff'>Close</font></a><br><br>";
