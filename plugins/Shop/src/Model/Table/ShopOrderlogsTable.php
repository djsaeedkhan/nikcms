 ...
 * @method \Shop\Model\Entity\ShopOrderlog patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \Shop\Model\Entity\ShopOrderlog[] patchEntities($entities, array $data, array $options = [])
 * @method \Shop\Model\Entity\ShopOrderlog findOrCreate($search, callable $callback = null, $options = [])
 *
 * @mixin \Cake\ORM\Behavior\TimestampBehavior
 */
class ShopOrderlogsTable extends Table
{
    /**
     * Initialize method
     *
