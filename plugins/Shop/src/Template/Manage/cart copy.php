...
<section id="content" dir="rtl" class="text-right">
    <div class="content-wrap pt-4 pb-1" style="overflow: visible;">
		...
		<div class="container">
            ...
            <table class="table table-striped1 text-right bg-white table-bordered">
                <thead>
                <tr>
                    <th>#</th>
                    <th>تصویر</th>
            ...
            foreach (array_reverse($shop['Orderproducts']) as $key => $item):
                ...
                <tr id="row_<?= $item['product_id'];?>" >
                    ...
                    <td>
                        <?= $this->html->image( 
                            ($item['image'] !=''?$item['image']:$shop_setting['product_default_image']), ['class'=>'img-thumbnail','style'=>'max-width:80px;max-heigth:80px;']); ?>
                    </td>
                    <td>
                    ...
                    <td>
                        <?php echo $this->Html->link('X', '/product/cart/remove/'.$key, [
                ...
                <tr>
                    ...
                    <td colspan="2" style="text-align: center;padding-left: 0;padding-right: 0;">
                        <?= $this->Html->link('حذف سبدخرید', 
                        '/product/cart/clear/empty', [
                            'title'=>'پاک کردن سبدخرید',
                            'style'=>'vertical-align: inherit;font-size: 12px;',
                            'class' => 'btn btn-danger btn-sm mb-1', 'escape' => false]); ?>
                            <!-- <br> -->

                        <?= $this->Form->button('<i class="fa fa-calculator"></i> &nbsp; بروز رسانی سبدخرید', [
            ...
            <?= $this->Form->end(); ?>
            <!-- ----------------------------------------------------------- -->
            <?= $this->Form->create($shopAddress,['id'=>'forms']);?>
            <div class="row">
            ...
            <?= $this->form->button('<i class="icon-angle-right shp_icn"></i> تکمیل سفارش', 
                ['class' => 'btn btn-success btn-sm float-right', 'escape' => false]); ?>
