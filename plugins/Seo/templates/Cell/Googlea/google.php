...
<div class="col-lg-8 col-md-6 col-12">
  <div class="card card-statistics">
    <div class="card-header">
        <h4 class="card-title">آمار لحظه ای</h4>
            ...
            <div class="col-xl-4 col-sm-6 col-12 mb-2 mb-xl-0">
              <div class="media">
                ...
                <div class="media-body my-auto">
                  ...
                  <p class="card-text font-small-3 mb-0">تعداد کاربر آنلاین</p>
                </div>
              </div>
            </div>
                    ...
                    if(($tmp = $results1->getRows())){
                      foreach($tmp as $tp){
                        if(isset($tp[0]) and $tp[0] == 'NEW')
                          echo '<span class="mb-1">کاربر جدید: '.$tp[1].'</span>';

                        if(isset($tp[0]) and $tp[0] == 'RETURN')
                          echo ' / <span class="mb-1">کاربر مجدد: '.$tp[1].'</span>';
                      }
                    } else echo '-';?>
                  </h41> 
                  <p class="card-text font-small-3 mb-0">بازدید کنندگان</p>                 
                </div>
              </div>
            </div>
            ...
            <div class="col-xl-4 col-sm-6 col-12 mb-2 mb-sm-0">
              <div class="media">
                ...
                <div class="media-body my-auto">
                    ...
                    <p class="card-text font-small-3 mb-0">تعداد بازدید کاربران آنلاین</p>
                </div>
              </div>
            </div>
  ...
  //-------------------------------------------------------------------------------
  $analytics2 = initializeAnalytics1();
  function getReport($analytics,$start='today' , $end='today') {
  ...
  ?>
    ...
    <div class="card-header">
        <h4 class="card-title"> آمار بازدید سایت</h4>
        <div class="d-flex align-items-center">
            ...
            <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-xl-0">
              <div class="media">
                ...
                <div class="media-body my-auto">
                  ...
                  <p class="card-text font-small-3 mb-0">بازدید امروز</p>
                </div>
              </div>
            </div>
            ...
            <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-xl-0">
              <div class="media">
                ...
                <div class="media-body my-auto">
                  ...
                  <p class="card-text font-small-3 mb-0"> هفت روز اخیر</p>
                </div>
              </div>
            </div>
            ...
            <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-sm-0">
              <div class="media">
                ...
                <div class="media-body my-auto">
                    ...
                    <p class="card-text font-small-3 mb-0"> ماه جاری</p>
                </div>
              </div>
            </div>
            ...
            <div class="col-xl-3 col-sm-6 col-12">
                <div class="media">
                    ...
                    <div class="media-body my-auto">
                        ...
                        <p class="card-text font-small-3 mb-0"> ماه گذشته</p>
                    </div>
                </div>
            </div>
            <!-- --------------------------------------------------------->
  ...
  <div class="card card-developer-meetup">
      <div class="card-body">
          <div class="meetup-header d-flex align-items-center">
              ...
              <div class="my-auto">
                  <h4 class="card-title mb-25">صفحات درحال بازدید</h4>
